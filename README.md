# soundKit_MT
Sound modding kit (SDKT) for Marvel Tokon
...
2. SDKT (Soundkit Modding Tool) is for:
   
   - Extracting and organizing most (playable, for now) character voices from Marvel Tokon

   - Extracting and organizing most, if not all, character voice subtitles from the game

   - Replacing ingame audio files with your custom files

   - Other, miscellaneous operations
   
   Character ID List can be found [here](<https://docs.google.com/spreadsheets/d/160YQ4scnSduVM6c7Ce1DDw9uAFpLKdaGdpatLZzrAT0/edit?gid=0#gid=0>)
...
- **Description**: soundKit_MT is a tool kit for modding sounds in Marvel Tokon, including organizing, renaming, manipulating, and compiling audio & text files. 
- **Project homepage**: https://github.com/BruhLookAtThis/soundKit_MT
- **Main developers/maintainers**: BruhLookAtThis  
- **Source code**: Available at https://github.com/BruhLookAtThis/soundKit_MT/releases
...
### UnrealPak
- **License**: (Unknown)
- **Description**: A tool for packaging Unreal Engine 5 assets.
- **Project homepage / Source code**: https://github.com/Dmgvol/UE_Modding/raw/main/Tools/UnrealPak.zip
- **Copyright holder**: Copyright (c) 2026 [FluffyQuack](<https://www.fluffyquack.com/>)
